...
async function getAITaskBreakdown(taskText) {
  ...
  const prompt = `
你是 MoodStudy 的學習任務拆解助手。
請把學生的大任務拆成 4 到 6 個具體、短小、容易打勾的小任務。
...
async function getGeminiReply(message) {
  ...
  const prompt = `
你是 MoodStudy 的 AI 學習陪伴助手。
你的任務是像溫柔的朋友一樣陪學生聊天，並在需要時提供學習建議。
...
5. 可以反問 1 個問題讓對話延續。
6. 回覆 2～5 句即可，不要太長。
7. 如果學生提到自殺、自殘、活不下去、傷害自己，請溫柔建議立刻找身邊可信任的人、學校輔導中心或當地緊急資源協助。
